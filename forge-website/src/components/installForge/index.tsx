...
const InstallForge = () => {
  return (
        ...
        <Typography variant="body1" component='a'  sx={{mt:2,textDecoration:'none'}} href='https://docs.linaroforge.com/latest/html/101136_arm-forge-user-guide/arm_forge/installing/index.html'><span style={{color:'#23b1da',textDecoration:'none !important'}}>How to install Linaro Forge</span></Typography>
