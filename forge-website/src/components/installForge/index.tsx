...
const InstallForge = () => {
  return (
        ...
        <Typography variant="body1" component='a'  sx={{mt:2,textDecoration:'none'}} href='https://developer.arm.com/documentation/101136/22-1-3/Arm-Forge/Installing-Arm-Forge'><span style={{color:'#23b1da',textDecoration:'none !important'}}>How to install Linaro Forge</span></Typography>
