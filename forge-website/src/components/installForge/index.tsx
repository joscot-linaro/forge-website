...
const InstallForge = () => {
  return (
        ...
        <Typography variant="body1" component='a'  sx={{mt:2,textDecoration:'none'}} href='https://docs.linaroforge.com/22.1.3/html/101136_arm-forge-user-guide/arm_forge/installing/index.html'><span style={{color:'#23b1da',textDecoration:'none !important'}}>How to install Linaro Forge</span></Typography>
        ...
        For more information about your evaluation license, see <Typography component='a' href="https://docs.linaroforge.com/22.1.3/html/101136_arm-forge-user-guide/arm_forge/licensing/workstation_evaluation_licenses.html" sx={{color:'#23b1da',textDecoration:'none !important'}}>how to setup your evaluation license.</Typography></Typography>
        </Box>
        </Grid>
  )
}
