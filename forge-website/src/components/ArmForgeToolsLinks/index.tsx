...
const ArmForgeToolsLinks = () => {
  return (
    <Grid  sx={{display:'flex',flexDirection:'column',borderRadius:0,borderColor:'white',ml:6,width:'100%',mt:4,mx:'auto',mb:2}}>
      <Typography variant="h5"  sx={{}}>Getting started</Typography>
