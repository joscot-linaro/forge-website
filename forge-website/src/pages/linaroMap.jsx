          ...
          <Grid container rowSpacing={1} sx={{ mx: 'auto', flexDirection: { xs: 'column', md: 'row', } }} columnSpacing={{ xs: 1, sm: 2, md: 0 }}>
            ...
            <Grid sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' } }}>
              <Grid item xs={6} sx={{ mx: { xs: 'auto', md: '0' }, }}>
                <CardMedia
                  component="img"
                  sx={{ height: 400, mx: { xs: 'auto', md: '0' }, mt: { xs: 4 } }}
                  image='/images/MAP_pic.jpg'
                  alt="Linaro Map image"
                />
              </Grid>
              <Grid item xs={6} sx={{ padding: { xs: 0, md: 4 }, mx: { xs: 'auto', md: '0' } }}>
                <Typography variant="h5" sx={{ mx: 'auto', ml: 2, p: 3, fontWeight: '500' }}>Linaro MAP Resources</Typography>
                <Typography variant="subtitle2" sx={{ display: 'flex', mt: 2, mx: 'auto', ml: 2, p: 2, width: { xs: '100%', s: '80%', md: '60%' } }}>
                  {mapResourceText}
                </Typography>
